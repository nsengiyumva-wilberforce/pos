                    ...
                    @foreach ($record->sellingDetails as $detail)
                        <tr>
                            ...
                            <td class="p-2 border text-center text-primary">
                                {{ Number::currency($detail->price_per_unit, Setting::get('currency', 'UGX')) }}</td>
                            <td class="p-2 border text-center text-primary">{{ $detail->qty }}</td>
                            <td class="p-2 border text-center text-primary">
                                {{ Number::currency($detail->discount_price, Setting::get('currency', 'UGX')) }}</td>
                            <td class="p-2 border text-center text-primary">
                                {{ Number::currency($detail->total_price, Setting::get('currency', 'UGX')) }}</td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot class="font-semibold">
                    <tr>
                        ...
                        <td class="p-2 border text-right text-primary">
                            {{ Number::currency($record->total_price, Setting::get('currency', 'UGX')) }}</td>
                    </tr>
                    <tr>
                        <td class="p-2 border text-center text-primary" colspan="3"></td>
                        <td class="p-2 border text-primary text-left">@lang('Discount')</td>
                        <td class="p-2 border text-right text-primary">
                            {{ Number::currency($record->total_discount_per_item + $record->discount_price, Setting::get('currency', 'UGX')) }}
                        </td>
                    </tr>
                    <!---->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="p-2 border text-right text-primary">
                            {{ Number::currency($record->tax_price, Setting::get('currency', 'UGX')) }}</td>
                    </tr>
                    <tr>
                        <td class="p-2 border text-center text-primary" colspan="3"></td>
                        <td class="p-2 border text-primary text-left">@lang('Total')</td>
                        <td class="p-2 border text-right text-primary">
                            {{ Number::currency($record->grand_total_price, Setting::get('currency', 'UGX')) }}</td>
                    </tr>
                    <tr>
                        <td class="p-2 border text-center text-primary" colspan="3"></td>
                        <td class="p-2 border text-primary text-left">@lang('Payed money')</td>
                        <td class="p-2 border text-right text-primary">
                            {{ Number::currency($record->payed_money, Setting::get('currency', 'UGX')) }}</td>
                    </tr>
                    <tr>
                        <td class="p-2 border text-center text-primary" colspan="3"></td>
                        <td class="p-2 border text-primary text-left">@lang('Money changes')</td>
                        <td class="p-2 border text-right text-primary">
                            {{ Number::currency($record->money_changes, Setting::get('currency', 'UGX')) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
