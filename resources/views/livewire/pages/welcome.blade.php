...
$mainFeatures = [
    ...
    [
        ...
        'description' => 'Nonci bisa diakses di android dan web',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
    ...
    [
        'title' => 'Configurable',
        'description' => 'Nonci bisa di konfigurasi sesuai kebutuhan anda',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
...
<div>
            ...
            <div class="max-w-7xl px-10 mx-auto flex lg:flex-row flex-col py-20">
                <div class="w-full lg:w-1/2 flex lg:justify-start justify-start md:justify-center hero-title">
                    <div class="lg:py-24  lg:text-left text-left md:text-center">
                        ...
                        <p
                            ...
                            Nonci merupakan aplikasi point of sale (POS) yang memudahkan pengelolaan bisnis Anda.
                            <br class="xl:block hidden"> Nonci hadir dengan fitur yang lengkap dan mudah digunakan.
                        </p>
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="mt-2">Nonci memudahkan saya dalam mengelola bisnis saya, terimakasih Nonci.</p>
                    </div>
    ...
    <section id="about" class="bg-gray-800 text-white py-32">
        <div class="lg:max-w-3xl mx-auto text-center px-5 lg:px-0">
            <p class="text-4xl font-extrabold">Tentang Nonci</p>
            <p class="text-lg mt-5">Nonci adalah aplikasi POS open-source dan juga gratis, Nonci tersedia untuk
                android dan web, dengan fitur yang dimiliki Nonci sekarang Nonci bisa memudahkan anda dalam mencatat
                keuntungan anda perhari dengan mudah, Nonci juga bisa membantu anda dalam mengelola barang yang ada di
    ...
    <section id="product-menu" class="py-10 my-10 text-gray-400">
        <div class="xl:max-w-7xl lg:max-w-4xl mx-auto">
            <p class="text-4xl font-extrabold text-center text-gray-800">Menu Nonci</p>
    ...
    <section id="main-feature" class="bg-gray-800 text-white py-32">
        <div class="md:max-w-4xl max-w-1xl mx-auto">
            <div class="mb-20 grid grid-cols-1 gap-y-5">
                <p class="text-4xl font-extrabold text-center">Fitur Nonci</p>
                <p class="text-lg text-center sm:mx-0 mx-5">Dengan Nonci anda bisa mengelola toko anda dengan mudah,
                    berikut fitur yang dimiliki oleh Nonci.</p>
            </div>
        ...
        <div class="bg-lakasir-primary text-center rounded-2xl my-20 p-10">
            ...
            <form action="#" class="mt-5 sm:mx-auto sm:flex sm:max-w-lg">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-3">
                    <button type="submit"
                        class="block w-full rounded-md border border-transparent bg-orange-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-lakasir-primary focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-Nonci-primary sm:px-10">Notify
                        me</button>
                </div>
            </form>
        </div>
